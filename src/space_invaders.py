...
from src.image_particle import ImageParticle
from src.delta_time_particle import DeltaTimeParticle
...
WHITE = (255, 255, 255)
SHIP_SPEED = 200
SHIP_IMAGE = MODULE_DIR / "../img/spaceship.png"
SHIP_SIZE = (58, 66)
BULLET_RADIUS = 2
BULLET_SPEED = -400
BOMB_RADIUS = 5
...
BONUS_SPEED = -100
BONUS_FADE = -200
UFO_IMAGE = MODULE_DIR / "../img/ufo.png"
UFO_SIZE = (77, 32)
UFO_START_SPEED = 100
